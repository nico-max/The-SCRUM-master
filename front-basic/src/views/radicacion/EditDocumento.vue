<template>
  <div>
    <div class="container">
      <v-card
        color="primary"
        class="elevation-0 mx-4 py-2 px-3 mb-2 rounded-lg d-flex align-center justify-left"
        height="100%"
        align-left
      >
      ...
      <v-row class="pl-4">
        <v-col cols="12" md="5" p="1">
          <div>
            <iframe src="/test.pdf" width="100%" height="500px"></iframe>
          </div>
        </v-col>
        <v-col cols="12" md="7" p="1">
          <v-card
            :loading="loading"
            color="secondary"
            class="elevation-0 mx-4 px-1 my-1 rounded-lg d-flex align-center justify-left"
            height="100%"
          >
            <v-row class="cyan-accent">
              <v-col cols="12" md="12" p="1">
                <div class="container argo-container-secondary">
                  <v-tabs
                    color="#deffff"
